...
public static class AuthConfiguration
{
    public static IServiceCollection AddAppAuth(this IServiceCollection services, IApiSettings settings)
    {
        ...
        {
            options.AddPolicy(AppScopes.FlowersRead, policy => policy.RequireClaim("scope", AppScopes.FlowersRead));
            options.AddPolicy(AppScopes.FlowersWrite, policy => policy.RequireClaim("scope", AppScopes.FlowersWrite));
        });
