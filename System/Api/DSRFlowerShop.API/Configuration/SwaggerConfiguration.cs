...
//using FlowerShop.Common.Security;
...
{
    private static string AppTitle = "DSR Flower Shop API";
            ...
            options.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
            {
                ...
                Flows = new OpenApiOAuthFlows
                {
                    Password = new OpenApiOAuthFlow
                    {
                        ...
                        {
                            {AppScopes.FlowersRead, "FlowersRead"},
                            {AppScopes.FlowersWrite, "FlowersWrite"}
                        }
                    },
